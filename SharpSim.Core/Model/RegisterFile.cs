...
namespace SharpSim.Model
{
    public class RegisterFile
    {
        ...
        {
            internal Register(string name, SSA.SSAType type, int offset, int width) : base(name, type, offset)
            {
                if (width < 1)
        ...
        {
            internal RegisterBank(string name, SSA.SSAType type, int offset, int count, int width, int stride) : base(name, type, offset)
            {
                if (count < 1)
        ...
        {
            internal VectorRegisterBank(string name, SSA.SSAType type, int offset, int arity, int count, int width, int stride) : base(name, type, offset)
            {
                if (arity < 1)
